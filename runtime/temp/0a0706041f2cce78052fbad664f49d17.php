<?php /*a:1:{s:75:"D:\phpstudy_pro\WWW\ThinkPHP5.1RBAC\application\admin\view\login\index.html";i:1585377139;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title><?php echo htmlentities((isset($title) && ($title !== '')?$title:"项目进度管理系统")); ?></title>
...
<body>
    <div id="login">
        <div class="login-wrap">
            ...
            <p class="copyright">Powered by <a href="https://www.zzsist.com">赛思特</a></p>
        </div>
    </div>
