                            ...
                            <div class="layui-colla-content" style="height:auto;">
                                ...
                                <ul>
                                    ...
                                    <li style="margin-top:10px;"><span class="layui-badge-dot layui-bg-blue"></span>&nbsp;<span
                                        ...
                                        <?php if($ope['url'] != null): ?>
                                        <br>
                                        <div style="background-color: lightgrey;width:auto;margin-left:20px;"><a href="<?php echo htmlentities($ope['url']); ?>" target="_blank"><span style="color:#25cee6;font-size: 18px;"><?php echo htmlentities($ope['url']); ?></span></a></div>
